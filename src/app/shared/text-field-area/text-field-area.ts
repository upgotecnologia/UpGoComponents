...
/**
 * Componente reutilizável de campo de texto multilinha (textarea)
 * baseado no Angular Material.
 *
 * ## 📌 Funcionalidades
 * - Integração com Reactive Forms
 * - Suporte a múltiplas linhas (textarea)
 * - Controle de tamanho via `rows`
 ...
 * | `rows`       | number     | ❌ Não     | Quantidade de linhas do textarea (default: 4) |
 *
 * ## 💡 Exemplo de uso
 *
 * ```html
...
@Component({
  ...
  templateUrl: './text-field-area.html',
  styleUrl: './text-field-area.scss',
})
export class TextFieldAreaComponent {
  /**
