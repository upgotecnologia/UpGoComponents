...
/**
 * Componente reutilizável de campo de busca baseado no Angular Material.
 *
 * ## 📌 Funcionalidades
 * - Integração com Reactive Forms
 * - Ícone de busca padrão (prefixo)
 * - Suporte a ícone sufixo opcional (ex: limpar busca)
 * - Ideal para filtros e pesquisas em listas
 ...
 * | `prefixIcon` | string     | ❌ Não     | Ícone exibido no início do campo (default: `search`) |
